				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
					<Card className="p-8 text-center">
						...
						<p className="text-gray-600 mb-6">
							Join our team of dedicated volunteers and help us make a direct impact in the community.
						</p>
						<Button 
							className="w-full"
					...
					<Card className="p-8 text-center">
						...
						<p className="text-gray-600 mb-6">
							Support our programs financially and help us reach more people in need.
						</p>
						<Link to="/donate">
